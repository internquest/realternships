...
const Hero = () => {
  return (
    <div className="h-max w-full gap-y-80 bg-white py-16 xl:py-20">
      ...
      <div className="mx-auto w-full px-4 pt-14 text-left md:text-center text-[20px] leading-[2.25rem]  md:leading-[2.8rem] sm:pt-20 sm:leading-[2.5rem] max-w-[762px] md:px-0 xl:pt-28">
