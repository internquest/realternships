...
const Poster = () => {
  return (
    <div
      className="mx-auto my-24 flex max-h-[588px] w-full max-w-[814px] items-center justify-center bg-cover bg-center p-8"
      style={{
        backgroundImage:
    ...
    >
      <div className="m-4 flex w-auto max-w-[735px] flex-col items-start gap-y-4 rounded-[20px] bg-[#FFFFFF] p-4 text-lg text-[#2C2C2C] sm:p-4 md:m-0 md:p-12 md:text-xl">
