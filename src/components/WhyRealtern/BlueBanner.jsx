...
const BlueBanner = () => {
  return (
    <div className="relative flex w-full items-center justify-center overflow-hidden rounded-b-[30px] bg-white pb-0 pt-[197px] shadow-xl shadow-gray-300/85 sm:pb-44 sm:pt-56 xl:rounded-b-[40px]">
      <div className="relative flex w-full items-center justify-center bg-[#4A5FF6]/90 py-28 lg:mx-28">
        <span
          className={`max-w-[743px] px-2 text-center text-2xl leading-[2.4rem] text-white sm:leading-[3rem] lg:w-[750px] ${MediumFont.className} `}
        >
      ...
      <span
        className={`absolute top-[97px] text-[88px] text-[#5F71F8]/30 sm:right-[70px] sm:top-[111px] sm:text-9xl lg:right-[182px] ${BoldFont.className}`}
      >
        realtern
      </span>
    </div>
