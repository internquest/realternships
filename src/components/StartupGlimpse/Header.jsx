...
const Header = () => {
  return (
    <div className="relative mx-4 mt-24 flex flex-col justify-center rounded-[10px] bg-[#F4DFC1]/90 px-8 py-16 md:px-16 md:pb-44 md:pt-24 lg:px-28 xl:px-36">
      <h1
        className={`mb-9 text-[48px] leading-[4.5rem] text-[#333] md:text-[64px] md:leading-[5.6rem] lg:mb-16 ${MediumFont.className} z-30 max-w-[880px]`}
      >
