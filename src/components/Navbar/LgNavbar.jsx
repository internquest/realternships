        ...
        <>
            ...
            <div className="flex justify-center items-center">
                <div className={`fixed top-0 z-50 pt-6 lg:pt-12 w-web max-w-[1300px]`}>
                    ...
                    <div className={`w-[94%] hidden md:flex py-3 pl-3 sm:pl-8 pr-3 text-white items-center justify-between mx-auto rounded-full absolute inset-x-0 ${MediumFont.className} ${hovered ? "bg-[#F7F6F2]" : "bg-black/30 backdrop-blur-lg bg-opacity-25 h-max"} `}
                    >
