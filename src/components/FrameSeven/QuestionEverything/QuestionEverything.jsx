    ...
    <div className="px-4 pb-4">
      <div className="rounded-[20px] bg-[#8423FE]">
        <div>
          ...
          <div
            className={`mx-auto mt-12 max-w-[850px] rounded-t-[10px] bg-[#FCD69C] px-12 pt-12 md:mt-20 md:pt-20 ${MediumFont.className} `}
          >
            <div className="mx-auto max-w-[700px] rounded-t-[10px] border-[5px] border-[#FAD49B]/50 bg-white p-8 text-[21px] leading-[2.7rem] text-[#544D49] md:text-[24px] md:leading-[3rem]">
