...
const RealternJourney = () => {
  return (
    ...
    >
      ...
      <div className="] mx-auto max-w-[842px] px-4 pb-24 text-white">
        <p
          className={`${MediumFont.className} text-[21px] leading-[2.4rem] md:text-center md:text-[24px] md:leading-[2.7rem]`}
        >
